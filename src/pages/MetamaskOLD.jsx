...
export default function MetaMask() {
  ...
  const metamaskLogin = async (event) => {
    ...
    var mobileCheckDestop = ('ontouchstart' in window || 'onmsgesturechange' in window)
    if (typeof ethereum !== "undefined") {
      ...
      // if(mobileCheckDestop){
      //   const dappUrl = "metamask-auth.ilamanov.repl.co"; // TODO enter your dapp URL. For example: https://uniswap.exchange. (don't enter the "https://")
      //   const metamaskAppDeepLink = "https://metamask.app.link/dapp/" + "Wallet.aarchik.com";
      //   localStorage.setItem("metamask", metamaskAppDeepLink[0]);
      // }
      // else{
        setModalIsOpen(true);
      // }
